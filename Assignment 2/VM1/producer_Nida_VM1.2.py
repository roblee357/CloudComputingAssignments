...
for i in range (100):
    ...
    print('Json Datetime string: ' + str(currentDatetime))
    formattedMsg = str(contents).replace('\\\\n', '\n')
    print (formattedMsg)
    producer.send('utilizations2', {'Timestamp':str(currentDatetime),'Top output':contents})
